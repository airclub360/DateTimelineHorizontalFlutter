...
class DatePicker extends StatefulWidget {
  ...
  const DatePicker(
    ...
    this.selectedDateStyle = defaultSelectedMonthTextStyle,
    this.selectedMonthStyle = defaultSelectedMonthTextStyle,
    this.selectedDayStyle = defaultSelectedMonthTextStyle,
